...
export default function Location() {
  ...
  return (
    <div className="relative top-[-110vh] sm:top-[-110vh] md:top-[-270vh] lg:top-[-200vh] xl:top-[-240vh]">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="w-full md:w-1/2">
                <div className="flex items-center gap-3 fabril-fatface">
                  ...
                  <ShinyText
                    ...
                    disabled={false}
                    speed={3}
                    className="custom-class fabril-fatface text-3xl"
                  />
                </div>
                <p className="text-[#BFBAB4] mt-2">
                  <ShinyText
                    text="Visit us at our premium restaurant in Ooty."
                    disabled={false}
                    speed={3}
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center text-center md:text-left">
                ...
                <p className="text-[#BFBAB4] mb-4">
                  <ShinyText
                    text="We are here to assist you with your dining experience."
                    disabled={false}
                    speed={3}
                    className="custom-class"
                  />
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="flex flex-col">
                    <label className="text-[#BFBAB4]" htmlFor="name">
                      Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="flex flex-col">
                    <label className="text-[#BFBAB4]" htmlFor="email">
                      Email
                    </label>
                    <input
                      type="email"
                  ...
                  <div className="flex flex-col">
                    <label className="text-[#BFBAB4]" htmlFor="message">
                      Message
                    </label>
                    <textarea
                      id="message"
